                        ...
                        <div class="form-group row border">
                             ...
                             <div class="col-md-8">
                                <div class="form-group">x
                                    ...
                                    <input type="text" class="form-control"  v-model="this.ultimoNumeroVenta" readonly="readonly">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row border">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Producto <h6><span class="badge badge-danger" v-show="idproducto==0">(*Ingrese código del producto1)</span></h6></label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Precio <h6><span class="badge badge-danger" v-show="precio==0">(*Ingrese un valor)</span></h6></label>
                                    <input type="number" value="0" step="any" class="form-control" v-model="precio">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Cantidad <h6><span class="badge badge-danger" v-show="cantidad==0">(*Ingrese un valor)</span></h6></label>
